...
const CartProduct = () => {
  return (
    <div className=" w-full h-full flex flex-col gap-6 pt-5 md:pt-0 ">
      <div className=" text-sm md:text-base font-['Poppins'] flex justify-between w-full px-3 shadow py-2 text-center">
      ...
      {/* <div className=" text-sm md:text-base font-['Poppins'] flex  justify-between w-full px-3 shadow py-2 text-center ">
        <div className="flex flex-col w-3/12   ">
          <img className="bg-cover w-[5%]" src={image} alt="" />
          <p>Lcd Monitor</p>
        </div>
      ...
      <div className="lg:flex justify-between lg:pt-10">
        <div className="flex justify-between h-full lg:gap-2 ">
          <input className="border-2  px-3 lg:py-4 lg:pr-36" type="text" name="" id="" placeholder="Coupon code" />

          <button className=" texr-xs border-2 bg-[#DB4444] text-white  font-['Poppins'] py-2 px-8   md:px-8 rounded  hover:text-white hover:bg-[#DB4444]  duration-500">
            Apply Coupon
          </button>
        </div>
