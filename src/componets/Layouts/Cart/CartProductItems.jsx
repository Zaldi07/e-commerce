  ...
  return (
    <div>
      {state.map((item, index) => {
        return (
          <div key={index} className=" text-sm md:text-base font-['Poppins'] flex  justify-between w-full px-3 shadow py-2 text-center items-center">
            <div className=" flex flex-col  lg:flex-row md:items-center w-3/12  pl-3  gap-2 md:lg-0  ">
              <img className="bg-cover w-[90%] md:w-[30%]" src={item.image} alt="" />
