...
const ProductChekout = (props) => {
  return (
    <div>
      ...
      <div className="font-['Poppins'] lg:w-[80%] text-justify border-b-[1px] border-black pb-2 lg:pb-8 lg:text-sm pr-2 pt-6">
        {props.text}
      ...
      <div className="flex gap-3 pt-5 ">
        ...
        <div className="flex gap-2   ">
          ...
          <div className=" flex items-center w-8 justify-center border-2  rounded-lg  border-black  border-opacity-50">
            <input type="radio" id="s" name="color" className="w-3 hidden checked:bg-green-500  " />
            <label htmlFor="xs">S</label>
          </div>
          <div className=" flex items-center w-8 justify-center border-2  rounded-lg border-black  border-opacity-50 ">
            <input type="radio" id="m" name="color" className="w-3 hidden checked:bg-blue-500 " />
            <label htmlFor="xs">M</label>
          </div>
          <div className=" flex items-center w-8 justify-center border-2  rounded-lg  border-black  border-opacity-50">
            <input type="radio" id="l" name="color" className="w-3 hidden checked:bg-blue-500 " />
            <label htmlFor="xs">L</label>
          </div>
          <div className=" flex items-center w-8 justify-center border-2  rounded-lg  border-black   border-opacity-50 ">
            <input type="radio" id="xl" name="color" className="w-3 hidden checked:bg-blue-500  text-indigo-600 bg-indigo-100 border-indigo-200 focus:ring-indigo-300" />
      ...
      <div className="lg:pt-8 pt-5 flex lg:gap-6 gap-2">
        ...
        <button className="bg-[#DB4444]  text-white font-sans   h-full w-32 py-3 lg:w-40 lg:py-3 rounded  hover:bg-indigo-400  duration-500">Buy Now</button>
        ...
        <div className="flex flex-col  lg:w-[80%]">
          <div className="flex  border-2 border-b-0">
            ...
            <div className="lg:pl-1 py-5">
              <h1 className="font-['Poppins'] font-medium text-base">Free Delivery</h1>
              <h1 className="font-['Poppins'] font-medium text-xs">Enter your postal code for Delivery Availability</h1>
            </div>
          </div>
          <div className="flex pt border-2">
            ...
            <div className="lg:pl-1 py-5">
              <h1 className="font-['Poppins'] font-medium text-base">Return Delivery</h1>
              <h1 className="font-['Poppins'] font-medium text-xs">Free 30 Days Delivery Returns. Details</h1>
            </div>
          </div>
        </div>
        <div></div>
