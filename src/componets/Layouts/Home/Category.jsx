  ...
  return (
    <div className="  w-full h-full pt-10  ">
      <div className="flex items-center w-full gap-3 lg:pb-10">
        ...
        <p className="text-sm lg:text-lg font-bold  text-[#DB4444]"> Categories</p>
      </div>
      <div className="w-full h-full">
        <div className=" flex  flex-row items-start lg:items-center justify-between lg:pb-5">
          <div className="flex items-center gap-36">
            <h2 className="  lg:pl-0 text-sm lg:text-3xl  pt-4 lg:pt-0 font-semibold font-['Poppins']  tracking-wider">Browser by category</h2>
          </div>

          <div className="  lg:flex gap-4  ">
            <button className="h-10 w-10 rounded-full  bg-[#F5F5F5]  " onClick={() => swiperRef.current?.slidePrev()}>
              <span>
                <ion-icon name="arrow-back-outline"></ion-icon>
              </span>
            </button>
            <button className="h-10 w-10 rounded-full  bg-[#F5F5F5] " onClick={() => swiperRef.current?.slideNext()}>
              <span>
      ...
      <div className="grid grid-cols-1 gap-5  justify-center pt-5 lg:pt-10">
        <div>
          ...
          >
            <SwiperSlide>
              <CardCategory warna="text-black" name="phone-portrait-outline" text="Electronics"></CardCategory>
            </SwiperSlide>
            <SwiperSlide>
              <CardCategory warna="text-black" name="diamond-outline" text="Jewerly"></CardCategory>
            </SwiperSlide>
            <SwiperSlide>
              <CardCategory warna="text-black" name="shirt-outline" text="Man clothing"></CardCategory>
            </SwiperSlide>
            <SwiperSlide>
              <CardCategory warna="text-black" name="shirt-outline" text="Women Clothing"></CardCategory>
            </SwiperSlide>
            <SwiperSlide>
              <CardCategory warna="text-black" name="shirt-outline" text="Women Clothing"></CardCategory>
            </SwiperSlide>
