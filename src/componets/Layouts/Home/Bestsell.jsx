  ...
  return (
    <div className="  pt-10 lg:pt-10 w-full h-full lg:pb- ">
      <div className="flex items-center w-full gap-3 lg:pb-12">
        ...
        <p className="text-sm lg:text-lg font-bold  text-[#DB4444]"> This month</p>
      </div>
      <div className="w-full h-full">
        <div className=" flex flex-row items-center  lg:items-center justify-between lg:pb-5">
          <div className="flex items-center  ">
            <h2 className=" pt-2 lg:pt-0 lg:pl-0 text-lg lg:text-3xl font-semibold font-['Poppins']  tracking-wider">Best Selling Products</h2>
          </div>
