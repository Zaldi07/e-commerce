  ...
  return (
    <Fragment>
      ...
      text-gray-800"
          ...
          <div onClick={() => setOpen(!open)} className="text-3xl absolute right-5 bottom-0 cursor-pointer md:hidden">
          ...
          <div className="w-[26%]  ">
            ...
            >
              {Links.map((link) => (
                <li key={link.name} className="  font-semibold hover:underline transition-all duration-400 md:ml-8 text-sm lg:text-base md:pl-1 md:my-0 my-7 ">
